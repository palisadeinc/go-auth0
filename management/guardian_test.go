...
func TestGuardian(t *testing.T) {
	t.Run(
		"MultiFactor", func(t *testing.T) {
				...
				"Phone", func(t *testing.T) {
					t.Run(
						"Provider", func(t *testing.T) {
							...
							t.Cleanup(
								func() {
									err = api.Guardian.MultiFactor.Phone.UpdateProvider(
										context.Background(), initialProvider,
									)
									assert.NoError(t, err)
								},
							)
					...
					t.Run(
						"Message-types", func(t *testing.T) {
							configureHTTPTestRecordings(t)
							...
							t.Cleanup(
								func() {
									err = api.Guardian.MultiFactor.Phone.UpdateMessageTypes(
										context.Background(), initialMessageTypes,
									)
									assert.NoError(t, err)
								},
							)
							...
							err = api.Guardian.MultiFactor.Phone.UpdateMessageTypes(
								context.Background(), expectedPhoneMessageTypes,
							)
							assert.NoError(t, err)
							...
							t.Cleanup(
								func() {
									err := api.Guardian.MultiFactor.SMS.UpdateTemplate(
										context.Background(), initialTemplate,
									)
									assert.NoError(t, err)
								},
							)
							...
							t.Cleanup(
								func() {
									err := api.Guardian.MultiFactor.SMS.UpdateTwilio(
										context.Background(), initialTwilio,
									)
									assert.NoError(t, err)
								},
							)
				...
				"Push", func(t *testing.T) {
					t.Run(
						"Provider", func(t *testing.T) {
							...
							t.Cleanup(
								func() {
									err = api.Guardian.MultiFactor.Push.UpdateProvider(
										context.Background(), initialProvider,
									)
									assert.NoError(t, err)
								},
					...
					t.Run(
						"AmazonSNS", func(t *testing.T) {
							...
							assert.Equal(
								t, expectedSNS.GetAPNSPlatformApplicationARN(),
								actualSNS.GetAPNSPlatformApplicationARN(),
							)
							assert.Equal(
								t, expectedSNS.GetGCMPlatformApplicationARN(), actualSNS.GetGCMPlatformApplicationARN(),
							)
						},
					)

					t.Run(
						"CustomApp", func(t *testing.T) {
							configureHTTPTestRecordings(t)
							...
							t.Cleanup(
								func() {
									err := api.Guardian.MultiFactor.Push.UpdateCustomApp(
										context.Background(), initialCustomApp,
									)
									assert.NoError(t, err)
								},
							)
					...
					t.Run(
						"DirectAPNS", func(t *testing.T) {
							...
							err = api.Guardian.MultiFactor.Push.UpdateDirectAPNS(
								context.Background(), expectedDirectAPNS,
							)
							assert.NoError(t, err)
			...
			t.Run(
				"WebAuthn Roaming", func(t *testing.T) {
					t.Run(
						"Enable", func(t *testing.T) {
							configureHTTPTestRecordings(t)
							...
							t.Cleanup(
								func() {
									err := api.Guardian.MultiFactor.WebAuthnRoaming.Enable(
										context.Background(), initialStatus,
									)
									require.NoError(t, err)
								},
							)
					...
					t.Run(
						"Settings", func(t *testing.T) {
							...
							t.Cleanup(
								func() {
									err := api.Guardian.MultiFactor.WebAuthnRoaming.Update(
										context.Background(), initialSettings,
									)
									require.NoError(t, err)
								},
							)
			...
			t.Run(
				"WebAuthn Platform", func(t *testing.T) {
					t.Run(
						"Enable", func(t *testing.T) {
							configureHTTPTestRecordings(t)
							...
							t.Cleanup(
								func() {
									err := api.Guardian.MultiFactor.WebAuthnPlatform.Enable(
										context.Background(), initialStatus,
									)
									require.NoError(t, err)
								},
					...
					t.Run(
						"Settings", func(t *testing.T) {
							...
							t.Cleanup(
								func() {
									err := api.Guardian.MultiFactor.WebAuthnPlatform.Update(
										context.Background(), initialSettings,
									)
									require.NoError(t, err)
								},
							...
							err = api.Guardian.MultiFactor.WebAuthnPlatform.Update(
								context.Background(), updatedSettings,
							)
							assert.NoError(t, err)
			...
			t.Run(
				"Recovery Code Enable", func(t *testing.T) {
					configureHTTPTestRecordings(t)
	...
	t.Run(
		"Enrollment", func(t *testing.T) {
			t.Run(
				"CreateTicket", func(t *testing.T) {
					configureHTTPTestRecordings(t)
