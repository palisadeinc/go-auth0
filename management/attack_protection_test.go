...
func TestAttackProtection(t *testing.T) {
	t.Run(
		"Get breached password detection settings", func(t *testing.T) {
	...
	t.Run(
		"Update breached password detection settings", func(t *testing.T) {
			configureHTTPTestRecordings(t)
			...
			assert.Equal(
				t, expected.GetStage().GetPreUserRegistration().GetShields(),
				actual.GetStage().GetPreUserRegistration().GetShields(),
			)
	...
	t.Run(
		"Get the brute force configuration", func(t *testing.T) {
			configureHTTPTestRecordings(t)
	...
	t.Run(
		"Update the brute force configuration", func(t *testing.T) {
			configureHTTPTestRecordings(t)
	...
	t.Run(
		"Get the suspicious IP throttling configuration", func(t *testing.T) {
			configureHTTPTestRecordings(t)
	...
	t.Run(
		"Update the suspicious IP throttling configuration", func(t *testing.T) {
			configureHTTPTestRecordings(t)
			...
			assert.Equal(
				t, expected.GetStage().GetPreLogin().GetMaxAttempts(), actual.GetStage().GetPreLogin().GetMaxAttempts(),
			)
			assert.Equal(
				t, expected.GetStage().GetPreUserRegistration().GetRate(),
				actual.GetStage().GetPreUserRegistration().GetRate(),
			)
			assert.Equal(
				t, expected.GetStage().GetPreUserRegistration().GetMaxAttempts(),
				actual.GetStage().GetPreUserRegistration().GetMaxAttempts(),
			)
