...
func TestOAuthLoginWithPassword(t *testing.T) {
	t.Run(
		"Should return tokens", func(t *testing.T) {
			configureHTTPTestRecordings(t)

			tokenSet, err := authAPI.OAuth.LoginWithPassword(
				context.Background(), oauth.LoginWithPasswordRequest{
					Username: "testuser",
	...
	t.Run(
		"Should support passing extra options", func(t *testing.T) {
			configureHTTPTestRecordings(t)
...
func TestLoginWithAuthCode(t *testing.T) {
	t.Run(
		"Should require client_secret or client assertion", func(t *testing.T) {
			_, err := authAPI.OAuth.LoginWithAuthCode(
	...
	t.Run(
		"Should throw for an invalid code", func(t *testing.T) {
			configureHTTPTestRecordings(t)
	...
	t.Run(
		"Should return tokens", func(t *testing.T) {
			...
			tokenSet, err := authAPI.OAuth.LoginWithAuthCode(
				context.Background(), oauth.LoginWithAuthCodeRequest{
					ClientAuthentication: oauth.ClientAuthentication{
						ClientSecret: clientSecret,
					},
	...
	t.Run(
		"Should support setting a redirect uri", func(t *testing.T) {
			configureHTTPTestRecordings(t)
...
func TestLoginWithAuthCodeWithPKCE(t *testing.T) {
	t.Run(
		"Should throw for an invalid code", func(t *testing.T) {
			...
			_, err := authAPI.OAuth.LoginWithAuthCodeWithPKCE(
				context.Background(), oauth.LoginWithAuthCodeWithPKCERequest{
	...
	t.Run(
		"Should throw for an invalid code verifier", func(t *testing.T) {
			configureHTTPTestRecordings(t)
...
func TestLoginWithClientCredentials(t *testing.T) {
	t.Run(
		"Should require client_secret or client assertion", func(t *testing.T) {
			_, err := authAPI.OAuth.LoginWithClientCredentials(
				context.Background(), oauth.LoginWithClientCredentialsRequest{
					Audience: "test-audience",
				}, oauth.IDTokenValidationOptions{},
			)
	...
	t.Run(
		"Should return tokens", func(t *testing.T) {
			...
			tokenSet, err := authAPI.OAuth.LoginWithClientCredentials(
				context.Background(), oauth.LoginWithClientCredentialsRequest{
					ClientAuthentication: oauth.ClientAuthentication{
						ClientSecret: clientSecret,
					},
	...
	t.Run(
		"Should allow overriding clientid", func(t *testing.T) {
			configureHTTPTestRecordings(t)
	...
	t.Run(
		"Should support using private key jwt auth", func(t *testing.T) {
			configureHTTPTestRecordings(t)
			...
			tokenSet, err := api.OAuth.LoginWithClientCredentials(
				context.Background(), oauth.LoginWithClientCredentialsRequest{
					Audience: "test-audience",
				}, oauth.IDTokenValidationOptions{},
			)
	...
	t.Run(
		"Should support passing private key jwt auth", func(t *testing.T) {
			configureHTTPTestRecordings(t)
	...
	t.Run(
		"Should error if provided an invalid algorithm", func(t *testing.T) {
			api, err := New(
				context.Background(),
				domain,
				WithIDTokenSigningAlg("HS256"),
			...
			_, err = api.OAuth.LoginWithClientCredentials(
				context.Background(), oauth.LoginWithClientCredentialsRequest{
					Audience: "test-audience",
				}, oauth.IDTokenValidationOptions{},
			)
...
func TestRefreshToken(t *testing.T) {
	t.Run(
		"Should return tokens", func(t *testing.T) {
			...
			tokenSet, err := authAPI.OAuth.RefreshToken(
				context.Background(), oauth.RefreshTokenRequest{
	...
	t.Run(
		"Should return tokens with reduced scopes", func(t *testing.T) {
			configureHTTPTestRecordings(t)
...
func TestRevokeRefreshToken(t *testing.T) {
	t.Run(
		"Should revoke token", func(t *testing.T) {
			configureHTTPTestRecordings(t)

			err := authAPI.OAuth.RevokeRefreshToken(
	...
	t.Run(
		"Should support passing a ClientID and ClientSecret", func(t *testing.T) {
			configureHTTPTestRecordings(t)
...
func TestWithIDTokenVerification(t *testing.T) {
	t.Run(
		"error for an invalid organization when using org_id", func(t *testing.T) {
	...
	t.Run(
		"error for an invalid organization when using org_name", func(t *testing.T) {
			extras := map[string]interface{}{
				"org_name": "wrong-org",
			}
			api, err := withIDToken(t, extras)
	...
	t.Run(
		"error for an invalid nonce", func(t *testing.T) {
			extras := map[string]interface{}{
				"nonce": "wrong-nonce",
			}
			api, err := withIDToken(t, extras)
	...
	t.Run(
		"error for an invalid maxage", func(t *testing.T) {
			extras := map[string]interface{}{
